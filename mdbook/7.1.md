...
public class GDXGame extends ApplicationAdapter {
    ...
    private void initAudioRes() {
        music = Gdx.audio.newMusic(Gdx.files.internal("ordinary_road.mp3")); // 底层是安卓的MediaPlayer
        ...
        sound = Gdx.audio.newSound(Gdx.files.internal("roll.wav")); // 底层为安卓的SoundPool
